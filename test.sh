...
assert 2 'main() { int a; if (1 == 1) a = 2; return a; }'
assert 3 'main() { int a; a = 3; if (1 != 1) a = 2; return a; }'
...
assert 3 'main() { int a; if (2 > 1) a = 3; else a = 4; return a; }'
...
assert 45 'main() { int sum; int i; i=0; sum=0; for (; i<10; i=i+1) sum=sum+i; return sum; }'
assert 3 'main() { for (;;) return 3; return 5; }'

assert 4 'main() { int a; int b; a=3; b=4; if (a < b) {int c; c=a; a=b; b=c;} return a; }'
assert 45 'main() { int sum; int i; sum=0; i=0; while(i<10) {sum = sum + i; i = i + 1;} return sum; }'
assert 135 'main() { int ans; int sum; int i; ans=1; sum=0; for (i=1; i<=5; i=i+1) { ans = ans * i; sum = sum + i;} return ans + sum; }'

assert 3 'main() { int a; a=ret3(); return a; } ret3() { return 3; }'
